    ...
    this.encrypt = function(plaintext, password) 
      {
        ...
        return this.Base64.encode(ciphertext);
      };
    ...
    this.decrypt = function(ciphertext, password) 
      {
        ...
        var v = this.strToLongs(this.Base64.decode(ciphertext));
        var k = this.strToLongs(Utf8.encode(password).slice(0,16)); 
        var n = v.length;
    ...
    this.Base64 = 
      {
         ...
         * @param {Boolean} [utf8encode=false] Flag to indicate whether str is Unicode 
         * string to be encoded to UTF8 before conversion to base64; otherwise string is 
         ...
         * @param {Boolean} [utf8decode=false] Flag to indicate whether str is Unicode string 
