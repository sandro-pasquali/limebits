...
var sh = {
	...
	utils : {
		...
		{   
		  AXIS.showNotification({
		    content:  sh.config.strings.alert + str,
		    type:     'scrollFollow'
		  });
	...
	all : function(params)
	{
	  /*
		...
		Sandro: removed this bit as the syntax highlighter, being a module, will
		always be executing after DOMReady... no need to wait for window load.
